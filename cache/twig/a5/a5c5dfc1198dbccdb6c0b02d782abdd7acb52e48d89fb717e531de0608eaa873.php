...
class __TwigTemplate_5fe6975eb2c46681adc9a1206638e513afa1637ba07e6c191cd36f2e9af48cf0 extends Twig_Template
{
...
\t\t\tlanguage_url:\"";
        // line 28
        echo twig_escape_filter($this->env, _twig_default_filter($this->env->getExtension('Grav\Common\Twig\TwigExtension')->urlFunc((("user://data/tinymce-editor/js/tinymce/langs/" . $this->getAttribute($this->getAttribute(($context["grav"] ?? null), "user", array()), "language", array())) . ".js")), _twig_default_filter($this->env->getExtension('Grav\Common\Twig\TwigExtension')->urlFunc((((("user://data/tinymce-editor/js/tinymce/langs/" . $this->getAttribute($this->getAttribute(($context["grav"] ?? null), "user", array()), "language", array())) . "_") . twig_upper_filter($this->env, $this->getAttribute($this->getAttribute(($context["grav"] ?? null), "user", array()), "language", array()))) . ".js")), _twig_default_filter($this->env->getExtension('Grav\Common\Twig\TwigExtension')->urlFunc((("plugins://tinymce-editor/js/tinymce/langs/" . $this->getAttribute($this->getAttribute(($context["grav"] ?? null), "user", array()), "language", array())) . ".js")), $this->env->getExtension('Grav\Common\Twig\TwigExtension')->urlFunc((((("plugins://tinymce-editor/js/tinymce/langs/" . $this->getAttribute($this->getAttribute(($context["grav"] ?? null), "user", array()), "language", array())) . "_") . twig_upper_filter($this->env, $this->getAttribute($this->getAttribute(($context["grav"] ?? null), "user", array()), "language", array()))) . ".js"))))), "html", null, true);
        echo "\",
\t\t\tplugins:\"";
        // line 29
