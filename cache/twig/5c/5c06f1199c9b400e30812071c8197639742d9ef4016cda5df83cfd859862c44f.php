...
class __TwigTemplate_92614ae4cc2b2dcdea98974d0358bc58312564e9cfcb7ebc5e741419821accbf extends Twig_Template
{
    ...
    ";
        ...
        ";
            ...
            echo "\">
                        ";
            // line 17
            echo $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["page"]) ? $context["page"] : null), "media", array()), "images", array()), $this->getAttribute($context["member"], "image", array()), array(), "array"), "cropZoom", array(0 => 360, 1 => 240), "method"), "html", array(), "method");
            echo "
                    </a>
...
";
    ...
    {
        return new Twig_Source("<section class=\"team\">
    <section class=\"section-title\">
        <div class=\"container text-center\">
            <h2>{{ page.title }}</h2>
            <span class=\"bordered-icon\"><i class=\"fa fa-circle-thin\"></i></span>
    ...
    {% for member in page.header.members %}
        ...
        {% endif %}
            <div class=\"col-md-4\">
                <figure class=\"thumbnail\">
                    <a href=\"{{ member.url }}\">
                        {{ page.media.images[member.image].cropZoom(360, 240).html() }}
                    </a>
                    <figcaption class=\"caption text-center\">
                        <h3>{{ member.name }}                            
                        </h3>
