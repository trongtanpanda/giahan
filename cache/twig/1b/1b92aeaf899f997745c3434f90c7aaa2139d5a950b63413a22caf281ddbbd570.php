...
class __TwigTemplate_8253335241f528a2c2e78361edc8b4d2ebd648a5f256e09f76d9e446a16f632e extends Twig_Template
{
    ...
    ";
        // line 8
        if ((twig_length_filter($this->env, $this->getAttribute($this->getAttribute(($context["page"] ?? null), "header", array()), "whys", array())) > 0)) {
            // line 9
            echo "        ";
            if ((twig_length_filter($this->env, $this->getAttribute($this->getAttribute(($context["page"] ?? null), "header", array()), "whys", array())) >= 4)) {
                // line 10
                echo "            ";
                ...
                // line 12
                echo "            ";
                $context["column_count"] = twig_length_filter($this->env, $this->getAttribute($this->getAttribute(($context["page"] ?? null), "header", array()), "whys", array()));
                // line 13
                echo "        ";
            }
            // line 14
        ...
        ";
            ...
            $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute(($context["page"] ?? null), "header", array()), "whys", array()));
            $context['loop'] = array(
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["solution"]) {
                // line 16
                echo "        ";
                if ((($this->getAttribute($context["loop"], "index", array()) % ($context["column_count"] ?? null)) == 1)) {
                    // line 17
                    echo "        <div class=\"row\">
        ";
                }
                ...
                echo twig_round((12 / ($context["column_count"] ?? null)));
                echo "\">
        ...
        ";
                // line 31
                if ((($this->getAttribute($context["loop"], "index", array()) == twig_length_filter($this->env, $this->getAttribute($this->getAttribute(($context["page"] ?? null), "header", array()), "whys", array()))) || (($this->getAttribute($context["loop"], "index", array()) % ($context["column_count"] ?? null)) == 0))) {
                    // line 32
                    echo "        </div>
        ";
                }
